...
struct MockData {
    static let product: Product = Product(id: "prod_QhixdsHITLlyKH",
    ...
    static let price: Price = Price(id: "price_1PqJVmEknSev8kwTSEG6oLbZ",
                                    object: "price",
                                    active: true,
    ...
    static var cartItems: [CartItem] = [
        CartItem(product: product, price: price, quantity: 1)
    ]
    
//    static var video: Video = Video(id: C95CadseJGs, snippet: VideoSnippet())
}
